      ...
      <el-col :xs="24" :sm="24" :md="9" :lg="9" :xl="9">
        <div class="row-flex flex-items-start flex-start">
            <div class="p-right-sm">
              <img :src="dataItem.VipObj.IMAGEURL?dataItem.VipObj.IMAGEURL:img" class="block" style="width:60px" />
            </div>
        ...
        <div v-for="(item,i) in VipObj" :key="i" class="font-16 marginTB-sm" v-if="i>2">
