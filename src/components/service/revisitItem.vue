        ...
        <div v-if="dataItem.VipObj" class="">
          ...
          <ul class="m-top-sm">
            <li class="paddingTB-sm paddingLR-xs border-bottom">
              <span>余额：</span>
              <span class="pull-right text-red">{{ dataItem.VipObj.MONEY }}</span>
            </li>
            <li class="paddingTB-sm paddingLR-xs border-bottom">
              <span>积分：</span>
              <span class="pull-right text-red">{{ dataItem.VipObj.INTEGRAL }}</span>
            </li>
            <li class="paddingTB-sm paddingLR-xs border-bottom">
              <span>次卡：</span>
              <span class="pull-right text-red">{{ dataItem.VipObj.COUPONNUM }}</span>
            </li>
            <li class="paddingTB-sm paddingLR-xs border-bottom">
              <span>欠款：</span>
              <span class="pull-right text-red">{{ dataItem.VipObj.OWEMONEY }}</span>
            </li>
            <li class="paddingTB-sm paddingLR-xs border-bottom">
              <span>消费次数：</span>
              <span class="pull-right text-red">{{ dataItem.VipObj.PAYCOUNT }}</span>
            </li>
            <li class="paddingTB-sm paddingLR-xs border-bottom">
              <span>消费金额：</span>
              <span class="pull-right text-red">&yen;{{ dataItem.VipObj.PAYMONEY }}</span>
            </li>
          </ul>
        </div>
      </el-col>
        ...
        <div class="paddingLR-sm m-left-md">
          <ul v-if="dataItem.VipObj" class="border-bottom">
            <li class="p-bottom-md paddingLR-xs">
              ...
              <span>
                【距今：
                <span v-text="farDate(dataItem.VipObj.LASTTIME)" class="text-red"></span>
                天】
              </span>
            </li>
            <li class="p-bottom-md paddingLR-xs">
              <span>单次最高消费：</span>
              <span class="text-red">&yen;{{ dataItem.VipObj.MAXMONEY }}</span>
            </li>
            <li class="p-bottom-md paddingLR-xs">
              <span>单次平均消费：</span>
              <span class="text-red">&yen;{{ dataItem.VipObj.AVGPRICE }}</span>
            </li>
          </ul>
          <div class="p-bottom-sm m-top-md">
            本次消费
            <span class="m-left-sm inline-blcok">{{ dataItem.SaleTime }}</span>
          </div>
          <div>
