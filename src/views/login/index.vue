  ...
  <div class="login-container_sock login">
    <transition name="fade" mode="out-in">
      ...
      <div v-else class="login-container">
        <el-form :model="ruleForm2" ref="ruleForm2" label-position="left" label-width="0px" style="height:450px;padding-top:10px;">
          ...
          <el-form-item prop="AuthCode">
            <div class="showEit-center-money-tt">
              <span>手机号码</span>
              <input type="text" v-model="ruleForm2.AuthCode" class="showEit-input" auto-complete="off" placeholder="请输入注册手机号" />
            </div>
          </el-form-item>
          <el-form-item prop="UserCode">
            <div class="showEit-center-money-tt">
              <span>用户账号</span>
              <input type="text" v-model="ruleForm2.UserCode" class="showEit-input" auto-complete="off" placeholder="请输入用户账号\boss" />
            </div>
          </el-form-item>
          <el-form-item prop="Password">
            <div class="showEit-center-money-tt">
              <span>登录密码</span>
              <input type="password" v-model="ruleForm2.Password" class="showEit-input" auto-complete="off" placeholder="请输入用户账号\boss" />
            </div>
          </el-form-item>
    ...
    <el-dialog title="请选择门店" :visible.sync="dialogVisible" width="330px" :close-on-click-modal='false' :modal-append-to-body="false" :before-close="handleClose">
  ...
  methods: {
    ...
    setShop(item) {
      ...
      if(!this.AgentPermission.success){
        this.$message({
          message: '用户账号权限存在问题，请重新登录', type: 'error'
        })
        this.dialogVisible = false
        return
      }
