    ...
    <el-container>
      ...
      <el-container>
        ...
        <el-container style="background:#fff">
          <div class="content-new-fex" style="background:#fff">
                        ...
                        <tr v-for='(item, index) in pageglist' :key='index'>
                            ...
                            <td>
                              <span v-for='(item1, index1) in item.SIZELISTQTY' :key='index1'>
                                <td align='center' style='padding:0 6px; width: 39px; font-size:10px; border-bottom:none'>
                                   <!-- {{item1.length == 1 ? '' : ''}} -->
              ...
              <table border='0' class='tableStock1' cellspacing='0' cellpadding='10' width='100%' style="height:auto; display:none">
                  ...
                  <tbody>
                    <tr v-for='(item, index) in pageglist1' :key='index'>
                      ...
                      <td>
                        <span v-for='(item1, index1) in item.SIZELISTQTY' :key='index1'  style='padding:0 6px; width: 39px; font-size:10px; border-bottom:none'>
...
export default {
  mixins: [MIXNINS_EXPORT.TOEXCEL, MIXNINS_EXPORT.TODATA, MIXINS_STOCK.STOCK_MENU],
  props: {
    dataType: {
      type: Object,
      default: function() {
  ...
  watch: {
    ...
    exportColumnData(data){
      ...
      var val = ["GOODSNAME", "GOODSCODE", "COLORNAME", "SIZENAME", "QTY", "PRICE"]
