    ...
    <div v-if="selectWg&& Object.keys(selectWg).length > 0">
        <div class="custom-item main-body" id="editbody">
            <el-form ref="form" label-width="100px" label-position="left">
                ...
                <!-- 网店信息 -->
                <template v-if="selectWg.type=='shopInfo'">
                    <el-form-item label="背景图片：">
                        <upload-img
                            @upload-img="upImage(0,{image:selectWg.value.image})"
                            :index="0"
                            :item="{image:selectWg.value.image}"
                        ></upload-img>
                        <p style="line-height:1.5">建议尺寸750x360像素，尺寸比例不匹配时，图片将被压缩拉伸以铺满画面</p>
                    </el-form-item>
                    ...
                    <div class="subItem">
                        ...
                        <el-form-item label="圆角：">
                            <span style="float:right">{{selectWg.value.style.radius}}%</span>
                            <el-slider
                                v-model="selectWg.value.style.radius"
                                :min="0"
                                :max="50"
                        ...
                        <el-form-item label="显示内容：">
                            <div>
                                <el-checkbox v-model="selectWg.value.name">店铺名称</el-checkbox>
                            </div>
                            <div>
                                <el-checkbox v-model="selectWg.value.address">店铺地址</el-checkbox>
                            </div>
                        </el-form-item>
                    </div>
                </template>
                ...
                <template v-if="selectWg.type=='goods'">
                    <div>
                        ...
                        <div v-show="selectWg.value.type=='auto'">
                            ...
                            <el-form-item label="名称高度">
                                <el-radio-group v-model="selectWg.value.nameHeight">
                                    <el-radio :label="1">一行</el-radio>
                                    <el-radio :label="2">两行</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="购买按钮">
                                <el-radio-group v-model="selectWg.value.buyNow">
                ...
                <template v-if="selectWg.type=='imgSlide'">
                    <div>
                        ...
                        >
                            <li v-for="(item, index) in selectWg.value.list" :key="index" style="overflow:hidden">
                                <div class="drag-block">
                                    ...
                                    <div class="handle-icon" title="删除这一项">
                                        <i class="el-icon-close" @click="handleSlideRemove(index)"></i>
                                    </div>
                                </div>
                                <transition name="fade">
                                    <div v-show="item.show" class="content">
                                        ...
                                        <select-link
                                            ...
                                            :index="index"
                                            :type.sync="item.linkType"
                                            :id.sync="item.linkValue"
                                        ></select-link>
                                    </div>
                                </transition>
                            </li>
                        ...
                        <li v-for="(item, index) in selectWg.value.list" :key="index">
                            <div class="content">
                                ...
                                <el-form-item label="添加按钮：">
                                    <el-switch v-model="item.buttonShow" active-color="#13ce66"></el-switch>
                                </el-form-item>
                                <el-form-item label="按钮文字：" v-if="item.buttonShow">
                                    <el-input v-model="item.buttonText" placeholder></el-input>
                                </el-form-item>
                                <el-form-item label="按钮颜色：" v-if="item.buttonShow">
                                    <el-color-picker v-model="item.buttonColor"></el-color-picker>
                                </el-form-item>
                                <el-form-item label="文字颜色：" v-if="item.buttonShow">
                    ...
                    <div>
                        <div class="content-item">
                            ...
                            <div class="tpl-block">
                                ...
                                >
                                    ...
                                    <div class="tpl-item-text">{{item.title}}</div>
                                </div>
                        ...
                        <div class="content-item">
                            <el-form-item label="图片间距：">
                                <el-slider v-model="selectWg.value.margin" :min="0" :max="30"></el-slider>
                            </el-form-item>
                            <span
                                style="display:inline-block;height:30px;line-height:30px;font-size:12px;margin-left:10px;"
                    ...
                    <div v-if="selectWg.value.type=='choose'">
                        ...
                        <div>
                            <a
                                ...
                                @click="selectNotice"
                            >
                                <i class="iconfont icon-choose1"></i>选择公告
                            </a>
                        </div>
                    </div>
                    <div class="pl25">
                ...
                <template v-if="selectWg.type=='navBar'">
                    <div>
                        <el-form-item label="每行数量">
                            <el-radio-group v-model="selectWg.value.limit" @change="changeNav">
                ...
                <!-- 底部导航-->
                <template v-if="selectWg.type=='footerNavBar'">
                    <div>
                        <div>
                            <el-button
                                size="small"
                                ...
                                style="width:45%"
                            >添加</el-button>
                            <el-button size="small" style="width:45%;float:right">恢复默认设置</el-button>
                        </div>
                        <div style="margin-top: 15px;font-size: 12px;color: #999;">
                            <em style="color:red">*</em>
                            <span>最多可添加</span>
                            <span>{{selectWg.value.limit}}</span>
                            <span>个底部导航，可删除后再次添加</span>
                        </div>
                        <draggable
                            element="ul"
                            :list="selectWg.value.list"
...
<script>
// import './js/ue/ueditor.config.js';
// import './js/ue/ueditor.all.js';
// import './js/ue/lang/zh-cn/zh-cn.js';
// import './js/ue/ueditor.parse.min.js';

import draggable from "vuedraggable";
import uploadImg from "./uploadImg.vue";
import selectLink from "./selectLink.vue";
import { default_banner, default_img, getWidgetName } from "./js/allWidget.js";
export default {
    name: "LayoutConfig",
    data: function() {
        var linkType = {
        ...
        var catList = [];
        var imgWindowArr = [
            require("./images/image-one-column.png"),
            require("./images/image-three-column.png"),
            require("./images/image-four-column.png"),
            require("./images/image-one-left.png")
        ];
        return {
            selectWg: {},
            _editocoverr: null,
    ...
    mounted() {
        ...
        that.$nextTick(function() {
            ...
            //     that._editocoverr.addListener(
            //         "beforeInsertImage",
            //         function(t, arg) {
            //             var obj = that._editocoverr.queryCommandValue(
            //                 "serverparam"
            //             );
            //             that.$set(
            //                 that.selectWg.value.list[obj.index],
            //                 "image",
            //                 arg[0].src
            //             );
            //         }.bind(that)
        ...
        //             } else {
        //                 that.$set(
        //                     that.selectWg.value.list[that.currentItemIndex],
        //                     "linkValue",
        //                     data.id
        //                 );
        //             }
    ...
    methods: {
        ...
        changeGoodsType: function(val) {
            if (val == "auto") {
                ...
                this.selectWg.value.list =
                    this.hasChooseGoods.length > 0
                        ? this.hasChooseGoods
                        : this.defaultGoods;
            }
        },
        changeNav(v) {
            let arr = this.selectWg.value.list,
                newArr = [];
            if (v < arr.length) {
                for (let i = 0; i < v; i++) {
                    newArr.push(arr[i]);
            ...
            this.selectWg.value.list = [...newArr];
        },
        ...
        selectNotice: function() {
            ...
            //                     //判断个数是否满足
            //                     if (
            //                         Object.getOwnPropertyNames(ids).length >
            //                         that.maxNoticeNums
            //                     ) {
            //                         layer.msg(
            //                             "最多只能选择" +
