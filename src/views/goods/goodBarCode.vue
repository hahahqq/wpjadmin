    ...
    <el-container>
                ...
                <div class="content-new-fex">
                    <div class="content-eightys">
                        <div class="content-center">
                            <el-button size="small" type="default" icon="el-icon-printer" @click="$router.push({ path: '/good/codePrinter'})">条码打印</el-button>
                            ...
                            <el-dropdown size='small' style="margin-left: 30px" @command="handleDropDown">
                                <el-button size="small" type="">
                                    条码规则设置<i class="el-icon-arrow-down el-icon--right"></i>
                                </el-button>
                            ...
                            <el-input
                                ...
                                v-model="searchText"
                                @keyup.enter.native='pageData.PN =1; getGoodsData(searchText)'
                                placeholder="商品编码/名称/单品条码"
                                class="pull-right"
                                style="width: 250px;"
                            >
                                <el-button slot="append" type="default" icon="el-icon-search" @click="pageData.PN = 1; getGoodsData(searchText)"></el-button>
                            </el-input>
                        </div>
                        ...
                        <div class="content-table4">
                            <div class="content-table-center">
                                ...
                                >
                                    ...
                                    <el-table-column label="商品名称" sortable fixed='left' width="180">
                                        <template slot-scope="scope">
                                            ...
                                            <span style='height:40px; width:102px'>
                                                <div class="text-3399ff pull-left inline-block" style="overflow: hidden; text-overflow:ellipsis;white-space: nowrap;">{{scope.row.NAME ? scope.row.NAME : ' '}}  </div>
                                                <div style="position:absolute; top: 26px; left: 60px">{{scope.row.CODE}}</div>
                                            </span>
                                        </template>
                                    </el-table-column>
                                    ...
                                    <el-table-column prop="BARCODE" label="单品条码" align="center" width="130"></el-table-column>
                                    ...
                                    <el-table-column label="操作" width="90">
                                        <template slot-scope="scope">
                                            <el-button type="text" size="small" @click='editCurBarCode(scope.$index, scope.row)'>修改</el-button>
                                        </template>
                                    </el-table-column>
                                </el-table>
        ...
        <el-dialog title="条码生成规则" :visible.sync="setBarCode" width="40%">
            <div>
                ...
                <div style="margin-left: 26px; font-size:10px; color:#999">按系统规则生成13位数字条码，长度统一便于打印</div>
            </div>

            <div style="margin-top: 20px">
                <el-radio v-model="barCodeType" label="1">货号+颜色条码+尺码条码</el-radio>
                <div style="margin-left: 26px; font-size:10px; color:#999">按货号+颜色条码+尺码条码生成条码</div>
            </div>
        ...
        <el-dialog title="颜色条码设置" :visible.sync="setColorCode" width="50%">
            <el-table :data="colorCodeList"
                ...
                element-loading-spinner="el-icon-loading"
                style="width: 100%;"
                header-row-class-name="bg-f1f2f3" class="full-width">
                <el-table-column align="center" label="序号" type="index"></el-table-column>
                <el-table-column align="center" label="颜色" prop="NAME" width='130'></el-table-column>
                <el-table-column align="center" label="系统条码" prop="COLORBARCODENO" width="200"></el-table-column>
                <el-table-column align="center" label="颜色条码">
                    <template slot-scope="scope">
                        <el-input size="mini" v-model="scope.row.CODE" onkeyup="value=value.replace(/[^\w/]/ig,'')" maxlength="15" style="text-align:center"></el-input>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <div class="m-top-sm text-right">
                ...
                <el-button type="primary" :loading='colorLoading' @click="saveColorBarCodeFun">保存</el-button>
            </div>
        </el-dialog>

        <el-dialog title="尺码条码设置" :visible.sync="setSizeCode" width="50%">
            <el-table :data="sizeCodeList"
                size='small' border
                :highlight-current-row='true'
                element-loading-text="数据加载中..."
                :height="560"
                ...
                <el-table-column align="center" label="系统条码" prop="SIZEBARCODENO" width="200"></el-table-column>
            ...
            <div class="m-top-sm text-right">
                ...
                <el-button type="primary" :loading='sizeLoading' @click="saveSizeBarCodeFun">保存</el-button>
            </div>
        </el-dialog>
...
export default {
    ...
    methods:{
        ...
        saveColorBarCodeFun(){
            ...
            this.$store.dispatch('colorCodeGroupSave', { ColorObj : JSON.stringify(ColorObj) } ).then(() =>{
