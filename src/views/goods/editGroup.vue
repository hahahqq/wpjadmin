<template>
  <div>
    <el-row>
      <el-col :span="2">
        <el-button size="small" type="info" icon="el-icon-close" @click="stopOrUseGoods(0)">
          停用
        </el-button>
      </el-col>
      <el-col :span="2">
        <el-button size="small" type="success" icon="el-icon-check" @click="stopOrUseGoods(1)">
          启用
        </el-button>
      </el-col>
      <el-col :span="2">
        <el-button size="small" type="danger" icon="el-icon-delete" @click="stopOrUseGoods(2)">
          删除
        </el-button>
      </el-col>
      <el-col :span="2">
        <el-button size="small" type="primary" icon="el-icon-edit" @click="showDialogFun">
          修改
        </el-button>
      </el-col>
    </el-row>
        ...
        <el-table-column label="商品名称" sortable fixed="left" width="160">
          <template slot-scope="scope">
            <img
              ...
              alt=""
              style="float: left; border-radius: 10px; width: 40px; height: 40px; margin-right: 8px"
            />
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="24" class="paddingTB-sm border-bottom1">
          ...
          <el-select
            ...
            @change="getBrandId(editItem.Brand)"
            clearable
            placeholder="请选择品牌"
            size="small"
          >
        ...
        <el-col :span="24" class="paddingTB-sm border-bottom1">
          ...
          <el-select
            ...
            size="small"
            placeholder="请选择材质"
            @click.native="getattributeStatus(6)"
            class="full-width"
          >
            <el-option
              size="small"
              v-for="(item, i) in PyearArr6"
              :key="i"
              :label="item.NAMELIST"
              :value="item.NAMELIST"
            ></el-option>
        ...
        <el-col :span="24" class="paddingTB-sm border-bottom1">
          ...
          <el-select
            ...
            allow-create
            filterable
            v-model="editItem.Style"
            :loading="loadingGroup"
            size="small"
            placeholder="请选择风格"
            @click.native="getattributeStatus(7)"
            class="full-width"
          >
            <el-option
              size="small"
              v-for="(item, i) in PyearArr7"
              :key="i"
              :label="item.NAMELIST"
              :value="item.NAMELIST"
            ></el-option>
        ...
        <el-col :span="24" class="paddingTB-sm border-bottom1">
          ...
          <el-select
            ...
            allow-create
            filterable
            v-model="editItem.Style1"
            :loading="loadingGroup"
            size="small"
            placeholder="请选择款式"
            @click.native="getattributeStatus(8)"
            class="full-width"
          >
            <el-option
              size="small"
              v-for="(item, i) in PyearArr8"
              :key="i"
              :label="item.NAMELIST"
              :value="item.NAMELIST"
            ></el-option>
        ...
        <el-col :span="24" class="paddingTB-sm border-bottom1">
          ...
          <el-select
            ...
            allow-create
            filterable
            v-model="editItem.Provenance"
            :loading="loadingGroup"
            size="small"
            placeholder="请选择产地"
            @click.native="getattributeStatus(9)"
            class="full-width"
          >
            <el-option
              size="small"
              v-for="(item, i) in PyearArr9"
              :key="i"
              :label="item.NAMELIST"
              :value="item.NAMELIST"
            ></el-option>
