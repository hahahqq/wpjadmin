...
import { 
  GET_LEVEL_LIST,GET_LEVEL_ITEM,DEAL_LEVEL_ITEM
...
const actions = {
  ...
  dealLevelItem ({commit},data) {  //会员等级保存
    let userInfo = getUserInfo()
    let sendData = {
  ...
  delLevelItem ({commit},data) {   //会员等级删除
    let userInfo = getUserInfo()
    let sendData = {
