...
// actions
const actions = {
  getIntegralList ({commit},data) {  //积分倍率列表
  ...
  getIntegralItem ({commit},id) {  //积分倍率详情
  ...
  dealIntegralItem ({commit},data) {  //积分倍率保存
    let userInfo = getUserInfo();
    let sendData = {
  ...
  delIntegralItem ({commit},{index,data}) {  //积分倍率删除
    let userInfo = getUserInfo();
    let sendData = {
  ...
  defaultIntegralItem ({commit},ID) { // 设为默认积分倍率
    let userInfo = getUserInfo();
    let sendData = {
