...
// actions
const actions = {
    getMallFreightList({ commit }) { // 运费模板列表
    ...
    editMallFreight({ commit }, data) { // 运费模板保存
        let userInfo = getUserInfo();
        let sendData = {
    ...
    delMallFreight({ commit }, data) { // 运费模板删除
        let userInfo = getUserInfo();
        let sendData = {
    ...
    getMallExpressList({ commit }) { // 快递列表
        let userInfo = getUserInfo();
        let sendData = {
    ...
    dealMallExpress({ commit }, { data, type }) { // 快递保存, 快递删除
        let userInfo = getUserInfo();
        let sendData = {
