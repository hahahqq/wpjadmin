  ...
  <div class="" >
          ...
          <el-table-column align='center' label="数量">
            <template slot-scope="scope">
              ...
              <span v-show="scope.row.notEdit">
                <el-input-number size="mini" style='width:90px' controls-position="right"  v-model.trim='scope.row.Qty' @keyup.enter.native='sureEditQty(scope.row,$event.target)'></el-input-number>
              </span>
            </template>
          </el-table-column>
    ...
    <div class="c_footer" style="margin-top: 10px">
      <el-row :gutter="24" style="margin-left: 0; margin-right: 0; border-top: 1px solid #e4e4e4">
        <el-col :span="8" style="padding:16px 16px; position:relative; border-right:1px solid #e4e4e4;">
          ...
          <div class="vip_sock" style="overflow: hidden; border-radius: 8px; color:#666; background: #f5f57fa; border: 1px solid #ddd; height:110px;">
        ...
        <el-col :span="8" style="padding:16px 16px;">
          <div class="cr_footer">
            <span style="display: inline-block; line-height: 40px">
              共
              <strong style='font-size:24pt; font-family:"宋体"; color:#f9484C'> {{Math.abs(totalQty)}}</strong> 件，
              合计 :
            ...
            <div style="text-align:center; margin-top: 20px">
              <el-checkbox v-model="IsSms" class="pull-left" style="line-height:40px">短信通知</el-checkbox>
              <el-button type="primary" style="width: 50%" @click="submitExchange" :loading="loading">确认兑换</el-button>
            </div>
    ...
    <el-dialog title="商品查询" :visible.sync="isShowList" width="80%" :close-on-click-modal='false' style="max-width:100%;" append-to-body>
       <shopqueryPage @closeModal="isShowList=false; searchVal=''; $refs.input.focus()" :goodsValSearch='goodsVal' :isIntegral='1' :shopViewType='1' @getSelectList="getSelectList"></shopqueryPage>
    </el-dialog>
...
export default {
  ...
  methods: {
    submitExchange(){
      ...
      let shopDataList = this.shopDataList, GoodsDetail = []
