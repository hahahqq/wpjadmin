  ...
  <div class="Recharge">
    <el-container>
      <el-container style="height:400px;">
        <el-aside width="40%" style="position:relative; background:none; text-align:left; line-height:normal">
          <div class="Rechargeleft">
            <ul>
              ...
              <li style="border-bottom:none; line-height:30px">
                <span class="pull-left" style="color:#ff5722" v-if="vipID != '' && integralToGoods != 0"> <i style="width: 60px; float:left">积分抵现</i> <i class="discountpon"> ￥{{integralToGoods}}</i> <i class="el-icon-circle-close p-left-xs" @click="delIntegral"></i></span>
              </li>
            </ul>
          </div>
