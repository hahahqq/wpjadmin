  ...
  <el-container>
    ...
    <el-container>
      ...
      <el-container>
        <div class="content-new-fex" id="printTest">
          ...
          <div class="content-eighty">
            <div class="content-center">
                <el-button size="small" @click="showAddPayWay = true" icon="el-icon-plus">新增</el-button>
                ...
                >
                  ...
                  <el-table-column label="操作">
                    <template slot-scope="scope">
                      ...
                      <el-button size='small' type="text" @click='handleDel(scope.row, scope.$index)' icon='el-icon-delete'>删除</el-button>
                    </template>
                  </el-table-column>
                </el-table>
              </div>
        ...
        <el-dialog title='新增支付账户' width="400px" style="max-width:100%" :visible.sync="showAddPayWay" append-to-body>
    ...
    handleEdit(item) {
      ...
      if (Object.keys(item).length > 0) {
        ...
        this.$prompt("", "请输入期初金额", {
          ...
          this.$store.dispatch("setFirstAccountMoney", { id: item.PAYTYPEID, money: value }).then(() => {
            this.loading = true;
          })
        }).catch(() => { });
      } else {
