...
import { 
  SERVICE_NOURISHING_LIST,
  SERVICE_NOURISHING_ITEM,
...
// actions
const actions = {
  getSNourishingList({commit}, data) {  // 护理提醒列表
...
const mutations = {
  [SERVICE_NOURISHING_LIST] (state, { data }) {
    ...
    state.sNourishingState = Object.assign({},data,{'paying':pageData,'List':state.sNourishingList});
  },
