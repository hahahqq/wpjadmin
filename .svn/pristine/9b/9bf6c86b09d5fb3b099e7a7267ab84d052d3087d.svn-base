...
import { 
  GET_CATEGORY_LIST,GET_CATEGORY_ITEM,DEAL_CATEGORY_ITEM,DEL_CATEGORY_ITEM
...
// actions
const actions = {
  getCategoryList ({commit},data) {   //商品分类列表
  ...
  getCategoryItem ({commit},id) {  //商品分类详情
    let userInfo = getUserInfo();
    let sendData = {
  ...
  dealCategoryItem ({commit},data) {  //商品分类保存
    let userInfo = getUserInfo();
    let sendData = {
  ...
  delCategoryItem ({commit},data) {  //商品分类删除
    let userInfo = getUserInfo();
    let sendData = {
